<template>
      <Card style="margin:10px;">
        <div slot="title">
         <h1 slot="title" style="margin:10px 0">项目节点</h1>
         <p>您需要指定基本的项目计划</p>
        </div>
    ...
    data(){
        return {
            ...
            createForm:{
                ...
                layout:"<div><Row :gutter='10'><Col :span='12'>{{name}}</Col><Col :span='12'>{{role}}</Col></Row><Row :gutter='10' style='marign-top:10px'><Col :span='12'>{{startDate}}</Col><Col :span='12'>{{endDate}}</Col></Row></div>",
                option:{}
            },
            orderForm:{
                def: {
    ...
    methods:{
        ...
        onNextStep(){
            ...
            this.$Modal.confirm({
                ...
                content:"确定提交项目组建信息",
                onOk(){
                    that.setProjectInstallState({id:that.id,state:3})
                }
            })
